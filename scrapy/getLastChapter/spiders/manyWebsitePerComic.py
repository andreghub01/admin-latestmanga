    ...
    def parse(self, response):
        if response.status == 200:
            ...
            if last_chapter == None:
                ...
                elif domain == "mangaowl.net" or domain == "mangaeden.com" or domain == "mangafox.online" or domain == "kissmanga.org" or domain == "m.mangabat.com":
                    search = last_chapter.find(":")
                    if search > 0 :
                        last_chapter = last_chapter[:search]
        ...
        data = {'jumlah_web': response.meta['jumlah_web'],'id_comic': response.meta['id_comic'],'id_result': response.meta['id'], "Api_Laravel": api_laravel}
        yield data
